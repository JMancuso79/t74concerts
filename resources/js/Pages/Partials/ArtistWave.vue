<template>
	<div>
        <div class="max-width mx-auto mb-4">
            <div class="bg-black pl-4 pr-4 pb-4 ml-4 mr-4 md:m-0">
                <div class="text-white pt-4">

                    <div style="width:100%;max-width:300px;" class="mx-auto">
                        <svg type="image/svg+xml" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 120 1024 120" xml:space="preserve"><g id="Layer_2_1_"></g> <g id="Layer_3"><g><circle cx="152.5" cy="206.9" r="8.3" class="st0" style="fill: rgb(255, 255, 255) !important;"></circle> <g><path d="M68.6,223.7c44.8,6.9,53.4-68,81.6-71.5c-19.7-7.9-35.2,5.7-44.4,23.6C95.8,195.2,86.4,215.8,68.6,223.7z" class="st0" style="fill: rgb(255, 255, 255) !important;"></path></g> <path d="M266.6,178.7c-10.8-21.8-24.2-47.2-52.3-44.5c15.2,7.5,25,28.7,33.9,44.5c11.4,22.8,24.3,47.9,52.6,45.2
                ...
                <div class="w-full mx-auto text-center text-gray-400">
                    <div style="font-weight:bold;" class="mt-2">
                        Reconnecting The Music Scene. Summer 2021
                    </div>
                    <div class="text-center mt-4 pb-2">
                        <a href="https://artistwave.com" target="_blank" class="secondary-button">Sign Up for Beta</a>
                    </div>
               </div>
           </div>
        </div>
