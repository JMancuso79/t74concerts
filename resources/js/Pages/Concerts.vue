                ...
                <div class="">
                    ...
                    <div class="">
                        ...
                        <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 mb-6">
                            <a href="https://tower74concerts.com/concert/tomorrows-bad-seeds-1331628688">
                                <img src="https://artistwavesoftware.s3-us-west-1.amazonaws.com/posts/62b9992dad863.jpeg" class="w-full" />
                            </a>
                            <div class="bg-white pt-4">
                                <a href="https://tower74concerts.com/concert/tomorrows-bad-seeds-1331628688">
                                    <h3 class="text-lg leading-6 font-bold text-blue-900">Tomorrows Bad Seeds @ The Viper Room</h3>
                                </a>
                                <p class="text-gray-900">Tickets are available online or at the door.</p>
                            </div>
                            <p>
                                <a href="https://tower74concerts.com/concert/tomorrows-bad-seeds-1331628688" class="mt-4 w-full block text-center px-4 py-2 border border-blue-300 shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-900">
                                    Buy Tickets
                                </a>
                            </p>
                        </div> 
