  ...
  <div class="min-h-full">
    ...
    <div class="relative bg-gray-900 py-32 px-6 sm:py-40 sm:px-12 lg:px-16">
        ...
        <div class="relative mx-auto flex max-w-3xl flex-col items-center text-center">
            ...
            <a href="/concert/en-young-imperial-sound-wital-vibes-659077554" class="mt-8 block w-full rounded-md border-2 border-white bg-transparent py-3 px-8 text-base font-bold text-white hover:bg-gray-100 hover:text-gray-800 sm:w-auto uppercase">Buy Tickets</a>
        </div>
    </div>
