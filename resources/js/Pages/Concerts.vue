 ...
 <div class="bg-primary">
    <div class="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
      <h2 class="text-3xl font-extrabold text-white sm:text-4xl">
        <span class="block">Tantric</span>
        <span class="block">@ Tiki Bar, November 26th</span>
      </h2>
      <p class="mt-4 text-lg leading-6 text-white">Tickets available online or at the door.</p>
      <a href="https://tower74concerts.com/concert/tantric-965870609" class="mt-8 w-full inline-flex items-center justify-center px-5 py-3 text-base bg-white text-black font-extrabold  sm:w-auto">
        Tickets & Info
      </a>
    </div>
