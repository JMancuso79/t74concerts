            ...
            <div class="lg:grid lg:grid-cols-2 lg:gap-8">
              <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                <div class="lg:py-24">
                  ...
                  <h1 class="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                    <span class="block">Tower 74 Presents</span>
                    <span class="pb-3 block bg-clip-text text-transparent bg-gradient-to-r from-teal-200 to-cyan-400 sm:pb-5">Josh Heinrichs</span>
                  </h1>
                    ...
                    <form action="#" class="sm:max-w-xl sm:mx-auto lg:mx-0">
                      <div class="sm:flex">
                        <div class="mt-3 sm:mt-0 sm:ml-3">
                          <button type="submit" class="block w-full py-3 px-4 rounded-md shadow bg-gradient-to-r from-teal-500 to-cyan-600 text-white font-medium hover:from-teal-600 hover:to-cyan-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-400 focus:ring-offset-gray-900">Buy Tickets</button>
                        </div>
                      </div>
              ...
              <div class="mt-12 -mb-16 sm:-mb-48 lg:m-0 lg:relative">
                <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0">
                  ...
                  <img class="w-full lg:absolute lg:inset-y-0 lg:left-0 lg:h-full lg:w-auto lg:max-w-none" src="/images/josh-sq.jpg" alt="" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="relative">
            <div class="text-center mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
              ...
              <p class="mt-5 mx-auto max-w-prose text-xl text-gray-500">
                Tickets to all three Southern California concerts are on sale now. 
              </p>
            </div>
            ...
            <div class="relative lg:-my-8">
              ...
              <div class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:p-0 lg:h-full">
                <div class="rounded-xl shadow-xl overflow-hidden lg:h-full">
                  <img class="object-cover h-full w-full" src="/images/venmo.jpg" alt="" />
                </div>
              </div>
            </div>
            <div class="bg-gradient-to-r from-teal-500 to-cyan-600 mt-12 lg:m-0 lg:col-span-2 lg:pl-8">
              <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:px-0 lg:py-20 lg:max-w-none">
                <blockquote>
                  <div>
                    <h2 class="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                        <span class="block">Ticket Package</span>
                    </h2>
                    <p class="mt-6 text-2xl font-medium text-white">
                      Buy tickets to all three shows and save $15 per person when you pay through Venmo. Send a note with the name of the primary ticket holder, the number of tickets and a venmo payment of $75 per person. The primary ticket holder's name will be on will call for each event with the number of tickets purchased.
                    </p>
                  </div>
        ...
        <div class="relative bg-gray-50 py-16 sm:py-24 lg:py-32">
          <div class="relative">
            <div class="text-center mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
              ...
              <p class="mt-5 mx-auto max-w-prose text-xl text-gray-500">
                Tickets to all three concerts are on sale now. 
              </p>
            </div>
            <div class="mt-12 mx-auto max-w-md px-4 grid gap-8 sm:max-w-lg sm:px-6 lg:px-8 lg:grid-cols-3 lg:max-w-7xl">
              <div v-for="post in blogPosts" :key="post.id" class="flex flex-col rounded-lg shadow-lg overflow-hidden">
...
const blogPosts = [
  {
    id: 1,
    title: 'The "Official" Preparty at DiPiazza\'s Long Beach',
    href: '#',
    date: 'Mar 16, 2020',
    datetime: '2020-03-16',
    category: { name: 'Friday, October 8th 2021', href: '#' },
    imageUrl:
      '/images/dipiazzas-sm-horiz.jpg',
    preview:
      'Eureka Sound, Rebel Shakedown, SGV Vibes, Ganda, Triple Thread with a special appearance by Josh Heinrichs.',
    author: {
  ...
  {
    id: 2,
    title: 'Josh Heinrichs at The Viper Room West Hollywood',
    href: '#',
    date: 'Mar 10, 2020',
    datetime: '2020-03-10',
    category: { name: 'Saturday, October 9th 2021', href: '#' },
    imageUrl:
      '/images/viper-sm-black-white.jpg',
    preview:
      'Josh Heinrichs, Eureka Sound, Rebel Shakedown and SGV Vibes.',
    author: {
      name: 'Brenna Goyette',
      imageUrl:
  ...
  {
    id: 3,
    title: 'Josh Heinrichs at Tiki Bar Costa Mesa',
    href: '#',
    date: 'Feb 12, 2020',
    datetime: '2020-02-12',
    category: { name: 'Sunday, October 10th 2021', href: '#' },
    imageUrl:
      '/images/tiki-sm-black-white.jpg',
    preview:
      'Josh Heinrichs, Eureka Sound, Rebel Shakedown, My Ruca and Farmacy Dub.',
    author: {
      name: 'Daniela Metz',
      imageUrl:
